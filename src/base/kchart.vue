	...
	export default {
		...
		methods: {
			initOpction() {
				...
				var geoCoorddata = [{
						name: '义乌大酒店',
						value: [120.093953, 29.324235]
					},
					{
						name: '江南会商务大酒店',
						value: [119.655002, 29.079744]
					},
					{
						name: '铂逸梦秦酒店',
						value: [120.324951, 29.140279]
					},
					{
						name: '永康明珠大酒店',
						value: [120.031492, 28.912199]
					},
					{
						name: '梦驿酒店(横店梦幻店)',
						value: [120.327065, 29.143625]
					},
					{
						name: '横店影星酒店(影视城官方酒店)',
						value: [120.325873, 29.157582]
					},
					{
						name: '兰溪国际大酒店',
						value: [119.44428, 29.216034]
					},
					{
						name: '横店度假村酒店(影视城官方酒店)',
						value: [120.324864, 29.151157]
					},
					{
						name: '伊美广场酒店',
						value: [120.079324, 29.307599]
					},
					{
						name: '锦江之星酒店(义乌店)',
						value: [120.089057, 29.326536]
					}
				];
					...
					bmap: {
						...
						mapStyle: { //地区上各种元素的样式调整
							styleJson: [{
								...
								'featureType': 'arterial', //调整干道名字是否可视
								'elementType': 'labels',
								'stylers': {
									'visibility': 'off'
								}
